...
<h1 align="center">kingdomcraft luncher</h1>
...
Si vous téléchargez à partir des Releases, sélectionnez le programme d'installation de votre système.
 ...
 Plateforme | Fichier |
| -------- | ---- |
| Windows x64 | `KingdomCraft-Luncher-win-x64.exe ` |
| macOS | `KingdomCraft-Luncher-mac-universal.dmg` |
| Linux x64 | `KingdomCraft-Luncher-linux-x86_64.AppImage` |
